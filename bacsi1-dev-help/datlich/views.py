...
# def get_list_doctor_of_department(department_id):
#     # user = request.user if request.user.is_authenticated else None
#     print("id:", department_id)
#     doctors = department_service.DepartmentService.get_doctors_by_department(department_id)
#     # departments = department_service.get_all_departments()
#
#     # context = {
#     #     "view": "listdoctor/fillterDoctorPage",
#     #     "file": "fillterDoctorPage",
#     #     "nav": "homePage/partials/navLogged",
#     #     "navState": "navLogged",
#     #     "listDoctorOfDepartment": doctors,
...
#         revenue = Schedule.objects.filter(date=date).aggregate(sum('doctor__service_prices'))['doctor__service_prices__sum'] or 0
...
#
# def create_schedule(request, doctor_id):
...
#         booking_models = doctor_service.get_list_booking_models_of_doctor(doctor_id)
#         doctor_response = doctor_service.get_doctor_response_by_id(doctor_id)
#
#         context = {
#             "doctor": doctor_response,
#             "list_booking_available": booking_models,
#         }
#         return render(request, "homePage/homeComponent/bookingComponent.html", context)
#
...
#         return Response(serializer.data, status=status.HTTP_200_OK)
#
# class FilterMedicalRecordView(APIView):
#     def get(self, request):
#         """
#         API để lọc hồ sơ y tế.
#         """
...
#         medical_records = medical_record_service.handle_filter_medical_record(
#             doctor_id=doctor_id, date=date, patient_name=patient_name, today=today
#         )
#         response = medical_record_service.map_data_medical_record_response(medical_records)
...
#     def post(self, request):
#         """
#         API để cập nhật hồ sơ y tế.
#         """
#         data = request.data
#         medical_record_service = MedicalRecordService()
#         medical_record_service.update_medical_record(data)
#         return Response({"message": "Medical record updated successfully"}, status=status.HTTP_200_OK)
